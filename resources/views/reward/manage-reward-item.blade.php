...
@section('content')
					...
					<div class="col-lg-6 col-7">
						<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
							<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
								...
								<li class="breadcrumb-item active"><a href="#" class="text-gray-dark">Manage Reward Item</a></li>
							</ol>
						</nav>
					</div>
					<div class="col-lg-6 col-5 text-right">
						@if ($my_menu['create'])
							<a href="{{ url('/reward/manage/item/create')}}" class="btn btn-sm btn-danger">Create</a>	
						@endif
					</div>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-12">
								...
								<div class="table-responsive">
									<table class="table align-items-center table-flush dataTable" id="manage_reward_item_table" width="100%">
	...
	@include('reward.script.manage-reward-item')
@endsection
